                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark bg-warning" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link text-dark" href="pelanggan.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4 bg-dark">
                        <h1 class="mt-4 text-white">Data Pelanggan</h1>
                        <div class="row">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$notelp;?></td>
                                            <td><?=$alamat;?></td>
                                            <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idpl;?>">
                                            edit
                                            </button>
                                        ...
                                        <div class="modal fade" id="edit<?=$idpl;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <input type="text" name="notelp" class="form-control mt-2" placeholder="No Telepone" value="<?=$notelp;?>">
                                                ...
                                                <button type="sumbit" class="btn btn-success" name="editpelanggan">Sumbit</button>
                                        ...
                                        <div class="modal fade" id="delete<?=$idpl;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="sumbit" class="btn btn-success" name="hapuspelanggan">Sumbit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="sumbit" class="btn btn-success" name="tambahpelanggan">Sumbit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
