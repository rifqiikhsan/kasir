                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$jumlah;?></td>
                                            <td><a href="view.php?idp=<?=$idpesanan;?>" class="btn btn-primary" target="blank">Tampilkan</a> <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idpesanan;?>">
                                            delete
                                            </button></td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="delete<?=$idpesanan;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <button type="sumbit" class="btn btn-success" name="hapuspesanan">Sumbit</button>
