                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link text-white" href="stock.php">
                                <div class="sb-nav-link-icon text-black"><i class="fas fa-clipboard-list"></i></div>
                                Daftar Menu
                            </a>
                            <a class="nav-link text-white" href="masuk.php">
                                <div class="sb-nav-link-icon text-black"><i class="fas fa-box"></i></div>
                                Menu Masuk
                            </a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idpr;?>">
                                            edit
                                            </button> 
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delate<?=$idpr;?>">
                                            Delete
                                            </button></td>
                                        </tr>
                                      ...
                                      <div class="modal fade" id="edit<?=$idpr;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title">Ubah Data DetailPesanan</h4>
                                                ...
                                                <button type="sumbit" class="btn btn-success" name="editdetailpesanan">Sumbit</button>
                                        ...
                                        <!-- The Modal -->
                                      <div class="modal fade" id="delate<?=$idpr;?>">
                                       <div class="modal-dialog">
                                         <div class="modal-content">
                                    ...
                                    <!-- Modal footer -->
                                    <div class="modal-footer">
                                     <button type="sumbit" class="btn btn-success" name="hapusprodukpesanan">Ya</button>
                                     <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                   </div>
