    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <input type="text" name="namapelanggan" class="form-control" placeholder="Nama Pelanggan" required="required">
          <input type="text" name="notelp" class="form-control mt-2" placeholder="No Telepon" required="required">
          <input type="text" name="alamat" class="form-control mt-2" placeholder="Alamat" required="required">
        </div>
